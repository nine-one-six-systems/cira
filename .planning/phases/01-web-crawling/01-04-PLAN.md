...
First, ensure the `frontend/src/__tests__/` directory exists:
```bash
mkdir -p frontend/src/__tests__
```

Then create the test file with necessary imports:
...
The `frontend/src/__tests__/` directory should already exist from Task 1.
